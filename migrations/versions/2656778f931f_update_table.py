...
Revision ID: 2656778f931f
Revises: 30f6c46a8de4
Create Date: 2020-07-14 23:16:27.320337
...
revision = '2656778f931f'
down_revision = '30f6c46a8de4'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    sa.Column('post_id', sa.Integer(), nullable=True),
    sa.Column('software_id', sa.Integer(), nullable=True),
    sa.ForeignKeyConstraint(['post_id'], ['post.id'], name=op.f('fk_tag_post_id_post')),
