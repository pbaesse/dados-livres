...
Revision ID: 3247c8cb1cdd
Revises: 61cb66d1521d
Create Date: 2020-08-03 16:03:03.026230
...
revision = '3247c8cb1cdd'
down_revision = '61cb66d1521d'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    sa.Column('similar', sa.String(length=200), nullable=True),
