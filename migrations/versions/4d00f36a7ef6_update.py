...
Revision ID: 4d00f36a7ef6
Revises: 2c821c23acd7
Create Date: 2020-08-22 01:11:05.844994
...
revision = '4d00f36a7ef6'
down_revision = '2c821c23acd7'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    sa.Column('software_category_id', sa.Integer(), nullable=True),
    sa.ForeignKeyConstraint(['software_category_id'], ['software.id'], name=op.f('fk_category_software_category_id_software')),
    sa.ForeignKeyConstraint(['source_category_id'], ['source.id'], name=op.f('fk_category_source_category_id_source')),
    ...
    sa.Column('software_tag_id', sa.Integer(), nullable=True),
    sa.ForeignKeyConstraint(['software_tag_id'], ['software.id'], name=op.f('fk_tag_software_tag_id_software')),
    sa.ForeignKeyConstraint(['source_tag_id'], ['source.id'], name=op.f('fk_tag_source_tag_id_source')),
