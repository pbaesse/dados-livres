"""Fiz os relacionamentos

Revision ID: 76d80dfa4ebc
Revises: 58c02f849e10
Create Date: 2019-11-15 21:35:03.718442
...
revision = '76d80dfa4ebc'
down_revision = '58c02f849e10'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    sa.Column('userSoftware_id', sa.Integer(), nullable=True),
    sa.ForeignKeyConstraint(['userSoftware_id'], ['user.id'], ),
    ...
    sa.Column('userSource_id', sa.Integer(), nullable=True),
    sa.ForeignKeyConstraint(['userSource_id'], ['user.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    op.add_column('user', sa.Column('typeUser', sa.String(length=200), nullable=True))
