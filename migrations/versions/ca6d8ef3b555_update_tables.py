...
Revision ID: ca6d8ef3b555
Revises: 99ed7135dcc3
Create Date: 2020-07-15 16:43:42.383215
...
revision = 'ca6d8ef3b555'
down_revision = '99ed7135dcc3'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    sa.ForeignKeyConstraint(['softwareSimilare_id'], ['software.id'], name=op.f('fk_similar_softwareSimilare_id_software')),
