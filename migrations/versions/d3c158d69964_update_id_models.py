...
Revision ID: d3c158d69964
Revises: 65b94bac54f8
Create Date: 2020-09-22 20:20:58.844556
...
revision = 'd3c158d69964'
down_revision = '65b94bac54f8'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    sa.Column('id_software', sa.Integer(), nullable=False),
    ...
    sa.PrimaryKeyConstraint('id_software', name=op.f('pk_software'))
    )
    ...
    sa.PrimaryKeyConstraint('id_source', name=op.f('pk_source'))
    )
    ...
    sa.ForeignKeyConstraint(['software_id'], ['software.id_software'], name=op.f('fk_category_software_id_software')),
    sa.ForeignKeyConstraint(['source_id'], ['source.id_source'], name=op.f('fk_category_source_id_source')),
    ...
    sa.Column('source_id', sa.Integer(), nullable=True),
    sa.Column('software_id', sa.Integer(), nullable=True),
    sa.ForeignKeyConstraint(['software_id'], ['software.id_software'], name=op.f('fk_comment_software_id_software')),
    sa.ForeignKeyConstraint(['source_id'], ['source.id_source'], name=op.f('fk_comment_source_id_source')),
    ...
    sa.Column('source_id', sa.Integer(), nullable=True),
    sa.Column('software_id', sa.Integer(), nullable=True),
    sa.ForeignKeyConstraint(['software_id'], ['software.id_software'], name=op.f('fk_report_software_id_software')),
    sa.ForeignKeyConstraint(['source_id'], ['source.id_source'], name=op.f('fk_report_source_id_source')),
    ...
    sa.Column('source_id', sa.Integer(), nullable=True),
    sa.Column('software_id', sa.Integer(), nullable=True),
    sa.ForeignKeyConstraint(['software_id'], ['software.id_software'], name=op.f('fk_tag_software_id_software')),
    sa.ForeignKeyConstraint(['source_id'], ['source.id_source'], name=op.f('fk_tag_source_id_source')),
